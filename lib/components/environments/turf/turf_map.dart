              ...
              child: Stack(
                children: [
                  ...mapData.territories.map((territory) {
                    ...
                    final bool isConquered = conqueredTerritoryIds.contains(
                      territory.id,
                    );
                    final double minWidth = 110.0;
                    final double minHeight = 80.0;
                    final double width = (mapWidth * territory.widthFactor)
                        .clamp(minWidth, mapWidth * 0.45);
                    final double height = (mapHeight * territory.heightFactor)
                        .clamp(minHeight, mapHeight * 0.35);
